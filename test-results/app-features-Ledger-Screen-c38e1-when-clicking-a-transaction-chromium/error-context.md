...
- Name: app-features.spec.ts >> Ledger Screen (Sổ Giao Dịch) E2E Tests >> should open TransactionDetailSheet when clicking a transaction
- Location: tests\e2e\app-features.spec.ts:356:7
