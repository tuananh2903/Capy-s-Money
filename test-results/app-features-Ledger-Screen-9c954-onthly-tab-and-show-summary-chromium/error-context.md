...
- Name: app-features.spec.ts >> Ledger Screen (Sổ Giao Dịch) E2E Tests >> should switch to Monthly tab and show summary
- Location: tests\e2e\app-features.spec.ts:320:7
