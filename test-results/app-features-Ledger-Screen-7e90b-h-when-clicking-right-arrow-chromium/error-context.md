...
- Name: app-features.spec.ts >> Ledger Screen (Sổ Giao Dịch) E2E Tests >> should navigate to next month when clicking right arrow
- Location: tests\e2e\app-features.spec.ts:347:7
