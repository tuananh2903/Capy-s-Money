...
- Name: app-features.spec.ts >> Ledger Screen (Sổ Giao Dịch) E2E Tests >> should switch to Calendar tab and show calendar view
- Location: tests\e2e\app-features.spec.ts:327:7
