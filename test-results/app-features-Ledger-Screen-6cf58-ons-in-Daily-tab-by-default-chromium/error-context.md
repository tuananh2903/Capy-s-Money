...
- Name: app-features.spec.ts >> Ledger Screen (Sổ Giao Dịch) E2E Tests >> should show transactions in Daily tab by default
- Location: tests\e2e\app-features.spec.ts:311:7
