...
- Name: app-features.spec.ts >> Ledger Screen (Sổ Giao Dịch) E2E Tests >> should navigate to previous month when clicking left arrow
- Location: tests\e2e\app-features.spec.ts:338:7
