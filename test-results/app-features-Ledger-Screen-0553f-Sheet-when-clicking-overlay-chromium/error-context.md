...
- Name: app-features.spec.ts >> Ledger Screen (Sổ Giao Dịch) E2E Tests >> should close TransactionDetailSheet when clicking overlay
- Location: tests\e2e\app-features.spec.ts:367:7
